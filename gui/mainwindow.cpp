    ...
    ui(new Ui::MainWindow)
{
    ...
    QObject::connect(this, &MainWindow::gotNoteOnEvent, midiWrapper, &MidiWrapper::playNoteOn, Qt::QueuedConnection);
    QObject::connect(this, &MainWindow::gotNoteOffEvent, midiWrapper, &MidiWrapper::playNoteOff, Qt::QueuedConnection);
